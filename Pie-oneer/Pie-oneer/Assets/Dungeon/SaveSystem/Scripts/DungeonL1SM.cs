...
public class DungeonL1SM : BaseSM
{
    ...
    public override void Load()
    {
        ...
        //LoadEnemies(SavingManager.Instance.savedData.dungeonLevel1.enemiesData);
    ...
    public override void SaveToSavedData()
    {
        ...
        //SavingManager.Instance.savedData.dungeonLevel1.enemiesData = GetEnemies();
